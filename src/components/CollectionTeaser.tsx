...
export const CollectionTeaser: React.FC = () => {
  ...
  const products: ProductItem[] = [
    ...
    {
      id: 'bone-five-panel',
      name: 'Boné Five Panel Canoeira',
      category: 'Proteção Solar & Lifestyle',
      line: 'Linha Proteção',
      lineCategory: 'protecao',
      badge: 'Cerrado Edition',
      image: '/assets/boneFivePanel.jpeg',
      specs: ['Modelagem Five Panel Anatômica', 'Aba Flexível Secagem Rápida', 'Proteção Solar FPU 50+'],
      description: 'O clássico Boné Five Panel da Canoeira com ajuste milimétrico, tecido leve de secagem ultrarrápida e proteção solar para o seu movimento e lifestyle.',
