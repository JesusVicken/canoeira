...
export const BrandLinesOverview: React.FC = () => {
  const lines = [
    ...
    },
    {
      ...
      tag: 'Linha 02',
      title: 'Proteção',
      subtitle: 'Bonés, viseiras e acessórios',
      desc: 'Acessórios solares projetados para bloquear 98% dos raios UV, com abas antirreflexo e materiais de secagem ultrarrápida.',
      items: ['Boné Solstício Hydro', 'Viseiras Solares', 'Proteção FPU50+ Vitalícia'],
      icon: ShieldCheck,
      accent: '#E6A15C',
      image: '/assets/canoeiraBone.jpeg',
      targetId: 'colecoes',
      actionText: 'Ver Proteção Solar',
    },
    {
      id: 'pausa',
